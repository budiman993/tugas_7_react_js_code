...
function PageCard(){
	return(
		...
		<Card.Text>
		Godin sekarang menjadi pemain Uruguay dengan caps terbanyak setelah memmbantu negaranya melibas Thailand di final Piala Tiongkok. Diego Godin boleh berbangga setelah resmi menjadi.
		</Card.Text>
		...
		" />
		<Card.Body>
		<Card.Title>Sani Rizki Fauzi Tegaskan Mental Pemain Timnas Indonseia U-23 Tetap Bagus</Card.Title>
		<Card.Text>
